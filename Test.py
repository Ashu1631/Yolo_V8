...
def make_fps_gauge(fps_val, model_label, gauge_key):
    """
    Plotly speedometer gauge — har call pe unique key isliye
    duplicate ID error nahi aata.
        ...
        if file:
            ...
            if file.name.lower().endswith(".mp4"):
                ...
                if compare:
                    ...
                    # Two separate gauge placeholders for two models
                ...
                while cap.isOpened():
                    ...
                    if compare:
                        ...
                        # Unique key per frame so no duplicate-ID error
